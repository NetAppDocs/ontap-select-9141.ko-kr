...
ONTAP Select 클러스터를 호스팅하는 하이퍼바이저에서 ESXi 소프트웨어를 업그레이드하기 전에 먼저 해야 합니다
사용자 환경에 적합한 업그레이드 절차를 준비하고 선택합니다.
...
* ONTAP Select 클러스터 크기입니다
단일 노드 클러스터와 다중 노드 클러스터가 모두 지원됩니다.
* ONTAP Select deploy를 사용합니다
배포 유틸리티를 사용하거나 사용하지 않고 업그레이드할 수 있습니다.
